...
UPSTREAM_REPO="https://github.com/MiSTer-devel/TI-99_4A_MiSTer.git"
CORE_NAME=(Ti994a)
...
UPSTREAM_CORE_NAME=(Ti994a)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Ti994a.qpf)
COMPILATION_OUTPUT=(output_files/Ti994a.rbf)
